...
dependency "sqs" {
  ...
  mock_outputs = {
    queue_url = "https://sqs.us-east-1.amazonaws.com/123456789012/e-voting-async-api-requests"
    queue_arn = "arn:aws:sqs:us-east-1:123456789012:e-voting-async-api-requests"
    dlq_arn   = "arn:aws:sqs:us-east-1:123456789012:e-voting-async-api-requests-dlq"
  }
}
...
inputs = {
  ...
  # ALB Configuration (optional for async)
